...
void readFile(char * "student.txt", char names[][41], char adds[][41], int * marks, int *pn)
{
	*pn = 0;
...
void writeFile(char * "student.txt", char names[][41], char adds[][41], int * marks, int n)
{
...
main()
{
	...
	char fileOut[] = "sorted_student.txt";
	char names[Nmax][41];
	char adds[Nmax][41];
	int marks[Nmax];
	int n = 0;
